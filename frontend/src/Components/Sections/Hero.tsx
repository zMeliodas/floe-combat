...
const Hero = () => {
  return (
    <div className="flex items-center w-full px-6 sm:px-10">
      <span className="hidden xl:block text-descText2 text-md font-montserrat font-bold rotate-90 tracking-widest pt-68">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col my-3 sm:my-5">
          <motion.h1
            ...
            className="text-white font-archivo tracking-tighter leading-none
              text-[3.5rem] xs:text-6xl sm:text-7xl md:text-8xl lg:text-[9rem] xl:text-[11rem]"
          >
            FLOE
          </motion.h1>
          ...
          <motion.h1
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.65 }}
            className="text-floesky font-archivo tracking-tighter leading-none
              text-[3.5rem] xs:text-6xl sm:text-7xl md:text-8xl lg:text-[9rem] xl:text-[11rem]"
          >
            COMBAT
          </motion.h1>
        ...
        <motion.p
          ...
          className="text-descText font-montserrat text-sm sm:text-lg font-light tracking-widest mb-6 sm:mb-8 max-w-xs sm:max-w-lg"
        >
